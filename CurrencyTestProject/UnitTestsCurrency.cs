...
namespace UnitTestsCurrency
{
    ...
    public class USCurrencyRepoTests
    {
        ...
        public void MakeChangeTests()
        {
            ...
            //Act
            changeTwoDollars = (USCurrencyRepo)repo.CreateChange(2.0);
            changeOneDollarOneHalfDoller = (USCurrencyRepo)repo.CreateChange(1.5);
            changeOneQuatersOnHalfDollar = (USCurrencyRepo)repo.CreateChange(.75);

            changeOneDimeOnePenny = (USCurrencyRepo)repo.CreateChange(.11);
            changeOneNickelOnePenny = (USCurrencyRepo)repo.CreateChange(.06);
            changeFourPennies = (USCurrencyRepo)repo.CreateChange(.04);
